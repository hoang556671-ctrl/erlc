...
def send_key_to_window(hwnd, vk_code, hold_time=0.05):
                                       
    scan_code = user32.MapVirtualKeyExW(vk_code, MAPVK_VK_TO_VSC, 0)
...
def send_key_hold_to_window(hwnd, vk_code, hold_time):
    scan_code = user32.MapVirtualKeyExW(vk_code, MAPVK_VK_TO_VSC, 0)
    lparam_down = (scan_code << 16) | 1
    lparam_up = (scan_code << 16) | 1 | (1 << 30) | (1 << 31)
